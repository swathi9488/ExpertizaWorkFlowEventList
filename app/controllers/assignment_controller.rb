...
#delete korak added
    ...
    #Delayed::Job.enqueue(DelayedMailer.new(2, deadline_type) , 1, 2.minutes.from_now)
     #Mailer.deliver_message(
     #   {:recipients => "korak103@gmail.com",
     #    :subject => "Your Expertiza assignment is being created",
     #    :body => {
     #      :user => self,
     #      :password => "shangrila",
     #      #:first_name => ApplicationHelper::get_user_first_name(self),
     #      :partial_name => "korak_test"
     #    }
     #   }
     #   )
#	print "should have sent an email"
